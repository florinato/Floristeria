...
public class ConsoleUI {
    ...
    private static void mostrarTickets() {
        ...
        try {
            tickets = floristeria.getDao().getTickets();  // Asumiendo que Floristeria tiene un método getDao() que expone el DAO
        } catch (Exception e) {
        ...
        if (tickets.isEmpty()) {
            ...
            for (Ticket ticket : tickets) {
                ...
                for (Producto producto : ticket.getProductos()) {  // Asumiendo que Ticket tiene un método getProductos()
    ...
    private static void addDecoracio() {
        ...
        double precio = Input.inputDouble("Ingrese el precio de la decoración: ");  // Asegúrate de manejar correctamente la entrada para evitar errores.
    ...
    private static void addFlor() {
        ...
        double precio = Input.inputDouble("");  // Asegúrate de manejar correctamente la entrada para evitar errores.
    ...
    private static void addArbre() {
        ...
        double altura = Input.inputDouble(""); // Asegúrate de manejar correctamente la entrada para evitar errores.
